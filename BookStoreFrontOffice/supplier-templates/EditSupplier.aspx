...
<body style="font-family: Arial, Helvetica, sans-serif; color: #33CCFF; background-color: #666666">
    <form id="form2" runat="server">
        ...
        <p>
            <asp:TextBox ID="txtSupplierNo" runat="server" BackColor="#333333" ForeColor="#33CCFF" style="z-index: 1; left: 446px; top: 509px; position: absolute"></asp:TextBox>
            <asp:Label ID="LblEditSupplier" runat="server" CssClass="auto-style1" Font-Bold="True" Font-Size="X-Large" Text="Edit a supplier:"></asp:Label>
        ...
        <asp:Button ID="btnFind" runat="server" BackColor="#333333" Font-Bold="True" ForeColor="#33CCFF" OnClick="btnFind_Click" style="z-index: 1; left: 1099px; top: 770px; position: absolute; height: 46px; width: 98px" Text="Find" />
        <p>
            &nbsp;</p>
        ...
        <p>
            ...
            <asp:Label ID="lblCost" runat="server" style="z-index: 1; left: 946px; top: 513px; position: absolute" Text="Cost:"></asp:Label>
            <asp:TextBox ID="txtCost" runat="server" BackColor="#333333" ForeColor="#33CCFF" style="z-index: 1; left: 1020px; top: 510px; position: absolute; width: 196px"></asp:TextBox>
            <asp:Label ID="lblSupplierNo" runat="server" style="z-index: 1; left: 322px; top: 511px; position: absolute" Text="Supplier No:"></asp:Label>
        </p>
        <p>
    ...
    <p style="text-align: left">
        ...
        <p>
            ...
            <asp:TextBox ID="txtPhoneNumber" runat="server" BackColor="#333333" CssClass="auto-style6" ForeColor="#33CCFF"></asp:TextBox>
        </p>
        ...
        <asp:Button ID="btnEdit" OnClick="btnEdit_Click" runat="server" BackColor="#333333" CssClass="auto-style12" Font-Bold="True" ForeColor="#33CCFF" Text="Apply Changes" />
        <asp:Label ID="lblError" runat="server" CssClass="auto-style16" Visible="False"></asp:Label>
        <asp:Button ID="btnView" runat="server" BackColor="#333333" ForeColor="#00CCFF" OnClick="btnView_Click" style="z-index: 1; left: 983px; top: 771px; position: absolute; height: 45px; width: 103px; right: 1039px" Text="View" Font-Bold="True" />
    </form>
</body>
